...
public record ProtocolMessage(
    ...
    public static ProtocolMessage hello(String token) {
        return hello(token, null);
    }

    public static ProtocolMessage hello(String token, String gameDirectory) {
        return new ProtocolMessage("hello", token, gameDirectory, null, null, null, null, null, null, null, null, null);
    }
    ...
    public static ProtocolMessage accepted(String messageId) {
        return new ProtocolMessage("accepted", null, null, messageId, null, null, null, null, null, null, null, null);
    }

    public static ProtocolMessage reply(String messageId, String text) {
        return new ProtocolMessage("reply", null, null, messageId, null, text, null, null, null, null, null, null);
    }

    public static ProtocolMessage error(String detail) {
        return new ProtocolMessage("error", null, null, null, null, detail, null, null, null, null, null, null);
    }

    public static ProtocolMessage chunkInfoRequest(String requestId, ChunkQuery query) {
        return new ProtocolMessage("chunk_info_request", null, null, null, null, null, null, requestId, query, null, null, null);
    }

    public static ProtocolMessage chunkInfoResponse(String requestId, ChunkInfo info) {
        return new ProtocolMessage("chunk_info_response", null, null, null, null, null, null, requestId, null, info, null, null);
    }

    public static ProtocolMessage gameQueryRequest(String requestId, GameQuery query) {
        return new ProtocolMessage("game_query_request", null, null, null, null, null, null, requestId, null, null, query, null);
    }

    public static ProtocolMessage gameQueryResponse(String requestId, GameQueryResult result) {
        return new ProtocolMessage("game_query_response", null, null, null, null, null, null, requestId, null, null, null, result);
    }
}
